...
public class SSGSServiceTest {
    ...
    public void test() throws BuzzException {
        ...
        Graph<Task<Long, Integer>, DefaultEdge> graph = GraphTypeBuilder
                .<Task<Long, Integer>, DefaultEdge> directed()
        ...
        Task<Long, Integer> task1 = new Task<>("1", "Task1", 1);
        graph.addVertex(task1);

        Task<Long, Integer> task2 = new Task<>("2", "Task2", 1);
        graph.addVertex(task2);

        Task<Long, Integer> task3 = new Task<>("3", "Task3", 2);
        graph.addVertex(task3);

        Task<Long, Integer> task4 = new Task<>("4", "Task4", 3);
        graph.addVertex(task4);

        Task<Long, Integer> task5 = new Task<>("5", "Task5", 5);
        graph.addVertex(task5);

        Task<Long, Integer> task6 = new Task<>("6", "Task6", 9);
        ...
        Map<Task<Long, Integer>, Long> durationMap = new HashMap<>();

        for(Task<Long, Integer> task : graph.vertexSet()) {
